<h2> <?php echo __l('Product Votes Reports'); ?> - <?php echo $product['Product']['name']; ?></h2> 
...
<?php  $chart_arr = array(); 
	 ...
	 $(document).ready(function() {
        chart<?php echo $qkey; ?> = new Highcharts.Chart({
            ...
            title: {
                text: "<?php echo ($qkey+1).') '.$productVote['Question']; ?>",
				style: {
            ...
            series: [{
                ...
                data: [
					<?php 
					if(!empty($productVote['Answer'])):
						foreach($productVote['Answer'] as $key => $value):
							echo '["'.$key.'",'.$value.'],';
						endforeach;
					endif; 
					?>
