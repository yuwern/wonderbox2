                    ...
                    <div class="brand-right">
                    	<div class="all-pro">
                    		...
                    		<ul class="all-products">
								...
								?>
                                <li <?php echo $class; ?>><?php     echo $this->Html->link($this->Html->showImage('Product',  $relatedProduct['Attachment'][0], array('dimension' => 'product_thumb', 'alt' => sprintf(__l('[Image: %s]'), $this->Html->cText($relatedProduct['RelatedProduct']['name'], false)), 'title' => $this->Html->cText($relatedProduct['RelatedProduct']['name'], false))).'<span class="shadow"></span><span class="bg_box"><span>'.$this->Html->cText($relatedProduct['RelatedProduct']['name'], false).'</span>'.Configure::read('site.currency').number_format($relatedProduct['RelatedProduct']['price'], 2, '.', '').'</span>', array('controller' => 'related_products', 'action' => 'view', $relatedProduct['RelatedProduct']['slug']),array('title' =>sprintf(__l('%s'),$relatedProduct['RelatedProduct']['name']), 'escape' => false)); ?></li>
								<?php
								endforeach;
								else:
								?>
