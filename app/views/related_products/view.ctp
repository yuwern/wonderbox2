		<div class="brand-main">
                    ...
                    <div class="brand-right">
                      ...
                      <div class="brand-sl-right">
                      	<p class="back-link"><?php echo $this->Html->link('&raquo;'.__l('Back To Brand Page'), array('controller' => 'product_redemptions', 'action' => 'view',$relatedProduct['ProductRedemption']['slug']),array('title' =>__l('Back'), 'escape' => false)); ?></p>
