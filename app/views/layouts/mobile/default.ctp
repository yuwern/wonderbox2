			...
			<div class="menu-block clearfix">
          	<ul class="menu clearfix">
               ...
               <?php endif; ?>
				...
				<?php if(!$this->Auth->sessionValid()):?>	
					<li <?php if($this->request->params['controller'] == 'pages' && $this->request->params['action'] == 'view' &&  $this->request->params['pass'][0] == 'company') { echo 'class="active"'; } else { echo 'class=""';}?>><?php echo $this->Html->link(__l('Business'), array('controller' => 'pages', 'action' => 'view', 'company', 'admin' => false), array('title' => __l('Business')));?></li>
				<?php endif; ?>
			</ul>            
							...
							<?php elseif($this->Auth->user('user_type_id') == ConstUserTypes::Company): ?>							
									...
									<?php else: ?>
										 <li <?php if($this->request->params['controller'] == 'companies' && $this->request->params['action'] == 'edit') { echo 'class="active"'; } ?>>
											 <?php echo $this->Html->link(__l('My Company'), array('controller' => 'companies', 'action' => 'edit',$user['Company']['id']), array('title' => __l('My Account'))); ?>
										 </li>
									<?php endif; ?>
      ...
      <div id="main" class="clearfix">
 		...
 		<div id="footer">
			...
			<?php
			 ...
			 <?php 
				$parsed_url = parse_url(Router::url('/', true));
			 	$mobile_site_url = str_ireplace('m.', 'touch.', Router::url('/', true));
			 	echo $this->Html->link(__l('Touch Version'), $mobile_site_url);
