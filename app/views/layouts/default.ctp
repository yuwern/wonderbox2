     ...
     <?php endif; ?>
		 <?php if ($this->Auth->sessionValid()): ?>
		  ...
		  <div class="head-subs">
	            ...
	            <p><?php echo __l('Next surprise:'); ?><span class="f16"> <?php echo $date_left; ?> days</span> left until <span class="f16"> <?php
				...
				?>'s</span>  Wonders Edition subscription closes <?php echo $this->Html->link(__l('Subscribe'), array('controller' => 'packages', 'action' => 'subscribe', 'admin' => false), array('class'=>'but2 f-rightbtn','title' =>__l('Subscribe')));?></p>
		...
		<div class="warper" id="<?php echo $this->Html->getUniquePageId();?>">
			...
			<div class="bot_sec">
				<div class="featured borderimg">
					<h2><?php echo __l('WonderBox October Edition'); ?></h2>
