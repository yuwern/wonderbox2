...
<!--[if IE 7]><link rel="stylesheet" type="text/css" href="<?php echo Router::url('/',true); ?>css/style-ie7.css" /><![endif]-->
...
<link rel="stylesheet" type="text/css" href="<?php echo Router::url('/',true); ?>css/colorbox.css" />
...
<script type="text/javascript" src="<?php echo Router::url('/',true); ?>js/libs/jquery.min.js"  ></script>
	...
	<script type="text/javascript" src="<?php echo Router::url('/',true); ?>js/libs/jquery.blockUI.js"  ></script>
	<script type="text/javascript" src="<?php echo Router::url('/',true); ?>js/libs/jquery.form.js"  ></script>
	...
	<script type="text/javascript" src="<?php echo Router::url('/',true); ?>js/libs/jquery.colorbox.js"></script>
