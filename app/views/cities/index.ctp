				...
				<li class="<?php echo $select_class;?>">
					<?php
						if (Cache::read('site.city_url', 'long') == 'prefix'):
							echo $this->Html->link($city['City']['name'], array('controller' => 'deals', 'action' => 'index', 'city' => $city['City']['slug']), array('class' => "$select_class", 'title' => $city['City']['name'], 'escape' => false));
...
<p class="suggestion-link"><?php echo $this->Html->link(__l('Don\'t see your city?'), array('controller' => 'city_suggestions', 'action' => 'add'), array('title' => __l('Suggest a City'), 'escape' => false)); ?></p>
</div>