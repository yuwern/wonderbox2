			...
			<div class="my-account">
				...
				<div class="userProfiles form js-responses">
					<h1><?php echo __l('Shipping Information'); ?></h1>
						...
						<?php echo $this->Form->create('UserProfile', array('action' => 'shipping', 'class' => 'normal-form js-ajax-form', 'enctype' => 'multipart/form-data'));?>
							  <ul>
                        		<li>
								<?php
								...
								?>
								  ...
								  <li><?php echo $this->Form->input('state_id',array('label' => __l('State *'))); ?> </li>
								  <li><?php echo $this->Form->input('country_id',array('label' => __l('Country *'),'selected'=>143)); ?> </li>
								   <li>
