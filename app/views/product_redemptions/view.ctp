                    	...
                    	<div class="pro-each-main-left">
                     	...
                     	<div class="pro-each-main-right">
                            ...
                            <ul class="all-products">
							   ...
							   <li><?php echo $this->Html->link($this->Html->showImage('RelatedProduct',  $relatedProduct['Attachment'][0], array('dimension' => 'product_normal', 'alt' => sprintf(__l('[Image: %s]'), $this->Html->cText($relatedProduct['name'], false)), 'title' => $this->Html->cText($relatedProduct['name'], false))).'<span class="shadow"></span><span class="bg_box"><span>'.$this->Html->cText($relatedProduct['name'],false).'</span>'.Configure::read('site.currency').number_format($relatedProduct['price'], 2, '.', '').'</span>', array('controller' => 'related_products', 'action' => 'view', $relatedProduct['slug'],'admin'=>false),array('title' =>sprintf(__l('%s'),$relatedProduct['name']), 'escape' => false));?></li>
								<?php  endforeach; ?>
                               </ul>
