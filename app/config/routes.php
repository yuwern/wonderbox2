<?php
/* SVN FILE: $Id: routes.php 60093 2011-07-12 13:38:38Z sakthivel_135at10 $ */
/**
...
if (Cache::read('site.city_url', 'long') == 'prefix') {
    ...
    if ($controllers === false) {
        ...
        array_push($controllers,  'page', 'user', 'admin', 'contactus', 'sitemap', 'robots', 'sitemap.xml', 'robots.txt');
